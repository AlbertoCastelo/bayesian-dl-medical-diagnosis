...
class BBB3Conv3FC(nn.Module):
    ...
    def __init__(self, outputs, inputs):
        ...
        self.conv1 = BBBConv2d(inputs, 32, kernel_size=5, stride=1, padding=2)
        self.soft1 = nn.Softplus()
        self.pool1 = nn.MaxPool2d(kernel_size=3, stride=2)

        self.conv2 = BBBConv2d(32, 64, kernel_size=5, stride=1, padding=2)
        self.soft2 = nn.Softplus()
        self.pool2 = nn.MaxPool2d(kernel_size=3, stride=2)

        self.conv3 = BBBConv2d(64, 128, kernel_size=5, stride=1, padding=1)
